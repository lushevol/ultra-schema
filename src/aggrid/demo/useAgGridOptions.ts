...
import type { OpenSearchQuery, OpenSearchResult } from "../../blotter-query/types/open-search-query";
import type { SettlementSchemaRootType } from "../../rtk-query/types.generated";

const DEFAULT_PAGE_SIZE = 100;

export const useAgGridOptions = <T>(queryCashflow: (args: OpenSearchQuery) => Promise<OpenSearchResult<SettlementSchemaRootType>>) => {
